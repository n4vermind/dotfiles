...
-- Widget
local profile = require("misc.dash.profile")
local music = require("misc.dash.music")
local media = require("misc.dash.mediakeys")
local time = require("misc.dash.time")
local date = require("misc.dash.date")
local todo = require("misc.dash.todo")
local weather = require("misc.dash.weather")
local stats = require("misc.dash.stats")
local notifs = require("misc.dash.notifs")
