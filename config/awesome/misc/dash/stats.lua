...
awesome.connect_signal("signal::volume", function(value, muted)
    ...
    vol.slider.value = value
    vol.slider.color = fill_color
    vol_tooltip.markup = helpers.colorize_text(value .. "%", vol_color)
end)
...
brightness:buttons(gears.table.join(
    -- Scrolling
    awful.button({}, 4, function() awful.spawn.with_shell("light -A 2") end),
    awful.button({}, 5, function() awful.spawn.with_shell("light -U 2") end)
))
